...
public class SauceTest {	
	...
	//Browserstack: Selenium Grid: HubUrl / Selenium Remote Url
	public static final String USERNAME = "munichandra_qJAfjs";
	public static final String AUTOMATE_KEY = "BqxoVSzaMPv6Mub3QzGY";
	public static final String URL = "https://" + USERNAME + ":" + AUTOMATE_KEY + "@hub-cloud.browserstack.com/wd/hub";
	
	@Parameters({"os", "os_version", "browser", "browser_version"})	
	@BeforeMethod
	public void setup(String os, String os_version, String browserName, String browser_version, Method name) throws IOException {
		...
		if (remote.matches("true")) {
			...
			System.out.println("Browserstack hub url is:"+URL);

			//Browserstack: DesiredCapabilities
			...
			//Selenium Grid: will run on perticular Cloud(AWS, Azure, GCP, SauceLabs, Browserstack)
			try {			
